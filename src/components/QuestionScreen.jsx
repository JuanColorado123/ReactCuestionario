      ...
      >
        ...
        <div className="flex justify-center space-x-4 mb-6">
          <button
            ...
            className={`${tab === 0 ? "bg-green-700" : "bg-green-500"
          ...
          <button
            ...
            className={`${tab === 1 ? "bg-green-700" : "bg-green-500"
              } hover:bg-green-700 text-white font-bold py-2 px-4 rounded`}
          >
            Preguntas
          </button>
          ...
          <>
            <div className="mb-4">
              <label className="block text-gray-700 text-sm font-bold mb-2">
                ¿Por qué estás interesado en este cuestionario?
              </label>
              <textarea
                name="message1"
            ...
            <div className="mb-4">
              <label className="block text-gray-700 text-sm font-bold mb-2">
                ¿Cuál es tu nivel de satisfacción con nuestro servicio?
              </label>
              <div className="flex flex-col space-y-2">
                <label>
                  <input
                    ...
                    name="satisfaccion"
                    value="alta"
                    checked={formData.satisfaccion === "alta"}
                    onChange={handleChange}
                    className="mr-2"
                  />
                  Alta
                ...
                <label>
                  <input
                    ...
                    name="satisfaccion"
                    value="media"
                    checked={formData.satisfaccion === "media"}
                    onChange={handleChange}
                    className="mr-2"
                  />
                  Media
                ...
                <label>
                  <input
                    ...
                    name="satisfaccion"
                    value="baja"
                    checked={formData.satisfaccion === "baja"}
                    onChange={handleChange}
                    className="mr-2"
                  />
                  Baja
              ...
              <div className="flex flex-col space-y-2">
                <label>
                  <input
                    ...
                    name="productos"
                    value="producto1"
                    checked={formData.productos.includes("producto1")}
                    onChange={handleChange}
                    className="mr-2"
                  />
                  Producto 1
                ...
                <label>
                  <input
                    ...
                    name="productos"
                    value="producto2"
                    checked={formData.productos.includes("producto2")}
                    onChange={handleChange}
                    className="mr-2"
                  />
                  Producto 2
                ...
                <label>
                  <input
                    ...
                    name="productos"
                    value="producto3"
                    checked={formData.productos.includes("producto3")}
                    onChange={handleChange}
                    className="mr-2"
                  />
                  Producto 3
